                                                                                        ...
                                                                                        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="font-size: 43px">Vaša žiadosť bola úspešne spracovaná!&nbsp;</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                        ...
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="font-size: 18px">Potvrďte prosím prevzatie vašich zariadení</span><span
                                                                                                        style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> kliknutím na nižšie uvedené tlačidlo.</span><span
                                                                                                        style="font-size: 18px">.</span>
                                                                                                </div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: center">
                                                                                                    <span
                                                                                                        style="color: #ffbe00; font-size: 18px"><strong>Vďaka!&nbsp;</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                            ...
                                                                                            <table border="0"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        <a href="{{route('request.verify', $request->id)}}"
                                                                                                           ...
                                                                                                           target="_blank">Potvrdiť prevzatie zariadení</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
